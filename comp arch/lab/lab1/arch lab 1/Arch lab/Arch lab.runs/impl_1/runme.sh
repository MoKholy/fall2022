...
HD_PWD='C:/Users/ArchLab/Arch lab/Arch lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log inverter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source inverter.tcl -notrace
