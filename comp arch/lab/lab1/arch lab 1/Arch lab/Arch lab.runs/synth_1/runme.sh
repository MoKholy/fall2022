...
HD_PWD='C:/Users/ArchLab/Arch lab/Arch lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log inverter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source inverter.tcl
