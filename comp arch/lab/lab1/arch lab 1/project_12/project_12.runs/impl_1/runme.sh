...
HD_PWD='C:/Users/ArchLab/project_12/project_12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Digit_Seven_Segment_Driver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Four_Digit_Seven_Segment_Driver.tcl -notrace
