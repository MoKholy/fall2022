...
HD_PWD='C:/Users/ArchLab/project_12/project_12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_Digit_Seven_Segment_Driver.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Four_Digit_Seven_Segment_Driver.tcl
